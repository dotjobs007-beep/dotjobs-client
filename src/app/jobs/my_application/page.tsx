...
import MyApplication from "@/Component/Protected/Job/My_Application";
import MyAmbassadorApplications from "@/Component/Protected/Ambassador/MyAmbassadorApplications";
...
export default function MyApplicationsPage() {
  ...
  return (
    <div>
      ...
      {/* Content */}
      <div className="-mt-16">
        {activeTab === "jobs" ? <MyApplication /> : <MyAmbassadorApplications />}
      </div>
    </div>
  );
}
