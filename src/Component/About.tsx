    ...
    <section className={`w-full py-16 px-6 lg:px-24  ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
      ...
      <div className="max-w-3xl mx-auto text-center mb-12">
        ...
        <p className="text-lg ">
          ...
          </span>. Our mission is simple: to connect projects, teams, and
          initiatives across the ecosystem with the right talent, while
          amplifying careers, opportunities, and the future of work in Web3.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        <p className="text-lg leading-relaxed text-center">
          ...
          </span>, unifying opportunities and talent under one open platform.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-start bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition">
            <Users className={`h-10 w-10 ${theme === "dark" ? "text-[#7F13EC]" : "text-[#AE1E67]"} mb-4`} />
            <h3 className="text-xl font-semibold mb-2">
              Ecosystem-Wide Opportunities
            </h3>
            <p className="text-gray-600 text-sm">
              Aggregate and showcase roles from Rollups, DAOs, Projects and ecosystem
              teams  connecting talent with meaningful opportunities across
              Polkadot and Kusama.
            </p>
          </div>
          ...
          {/* On-Chain Identity */}
          <div className="flex flex-col items-start bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition">
            <Shield className={`h-10 w-10 ${theme === "dark" ? "text-[#7F13EC]" : "text-[#AE1E67]"} mb-4`} />
            <h3 className="text-xl font-semibold mb-2">On-Chain Identity</h3>
            <p className="text-gray-600 text-sm">
              Users verify their identity using Polkadot Identity and
              integrations like Polkassembly creating a trust-driven hiring
              environment.
            </p>
          </div>
          ...
          {/* Awareness & Education */}
          <div className="flex flex-col items-start bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition">
            <BookOpen className={`h-10 w-10 ${theme === "dark" ? "text-[#7F13EC]" : "text-[#AE1E67]"} mb-4`} />
            <h3 className="text-xl font-semibold mb-2">Awareness & Education</h3>
            <p className="text-gray-600 text-sm">
