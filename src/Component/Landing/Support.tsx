...
export default function Support() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-12" aria-labelledby="support-heading">
      <div className="text-center mb-8">
        <h2 id="support-heading" className="text-3xl font-semibold">Support</h2>
      ...
      <div className="">
        ...
        <div className="lg:col-span-2">
          <Card className="shadow sm:rounded-lg p-6">
            ...
            <p className="text-sm text-gray-500 mt-1">Describe your issue and we will get back to you as soon as possible.</p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 grid grid-cols-1 gap-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full rounded-md border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 ${errors.name ? 'border-red-400' : ''}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full rounded-md border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 ${errors.email ? 'border-red-400' : ''}`}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className={`mt-1 block w-full rounded-md border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 ${errors.message ? 'border-red-400' : ''}`}
              ...
              <div className="flex items-center space-x-3">
                ...
                {status === 'success' && <p className="text-green-600 text-sm">Message sent — we will be in touch.</p>}
